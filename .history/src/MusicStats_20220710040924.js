...
function MusicStats({audiodata}) {
    ...
    function setValenceColor(val) {
      ...
      return (<Container>
            <h1>Happiness corresponds to the color wheel in the creation of the musiac. The most happy music willproduces a more purple/pink color, while sadder music   </h1>
