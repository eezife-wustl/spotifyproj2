      ...
      <div className="main">
          ...
          {/* {items.map((track, index) => (
            ...
            <div className="toAlignStuff">
              ...
              <div className="Artwork">{isLoaded ? <Art className="test" audiodata={sound}/> : 'not calculated'} </div> 
              <div className="ArtworkDesc">  {isLoaded ? <MusicStats audiodata={sound}/> : 'not calculated'}</div>
      </div>
    );
  }
