...
let DY = (distortion) * (b-y) + y;
 ...
 //   p5.fill(red, sat, bal);
 drawTriangle3(p5, p5.windowWidth/4,p5.windowWidth/4, p5.windowWidth/4,0, 0,0, danceability, vl, pz);
  //  p5.fill(blue, sat, bal);
    drawTriangle3(p5, 0,0, 0,p5.windowWidth/4, p5.windowWidth/4,p5.windowWidth/4, danceability, vl, pz);
