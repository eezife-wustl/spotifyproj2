...
function Art({audiodata}) {
  ...
  const draw = p5 => {
   ...
   //let dance = 0.8;
    ...
    p5.fill(red, sat, bal);
    drawTriangle3(p5, 0,0, 400,0, 400,400, danceability, red);
    p5.fill(blue, sat, bal);
    drawTriangle3(p5, 0,0, 0,400, 400,400, danceability, blue);
    p5.fill(green, sat, bal);
    drawTriangle3(p5, 0,400, 400,400, 400,0, danceability, vl);
    p5.fill(yellow, sat, bal);
    drawTriangle3(p5, 400,0, 400,400, 0,400, danceability, vl);
  }
