...
function MusicStats({audiodata}) {
    ...
    function setValenceColor(val) {
      ...
      return (<Container>
            <h1>Happiness corresponds to the color wheel in the creation of the musiac. The saddest music will produce a more blue color, while the happiest music will produce    </h1>
