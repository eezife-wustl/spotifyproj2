...
function MusicStats({audiodata}) {
    ...
    function setMusicTaste(val) {
      ...
      return (<Container>
            <h1> The most negative music will produce a more blue-ish hue, while the most positive music will produce a more purple hue. Your music taste tends to be {setMusicTaste(val)}  </h1>
