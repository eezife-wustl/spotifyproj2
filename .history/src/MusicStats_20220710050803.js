...
function MusicStats({audiodata}) {
    ...
    function setMusicTaste(val) {
      ...
      return (<>
            <span> Valence describes musical positivity. When generating your musi The most negative music will produce a more blue-ish hue, while the most positive music will produce a more purple hue. The music you listen to tends to be <b>{setMusicTaste(valence)}</b>.  </span>
        <Container>
