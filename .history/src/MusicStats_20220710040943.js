...
function MusicStats({audiodata}) {
    ...
    function setValenceColor(val) {
      ...
      return (<Container>
            <h1>Happiness corresponds to the color wheel in the creation of the musiac. A more happy music will produce a more purple/pink color, while the saddest music   </h1>
