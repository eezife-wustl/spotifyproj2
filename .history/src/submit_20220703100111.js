...
function Submit(props) {
   ...
   // const [audio, setAudio] = useState([]);
    ...
    const handleSubmit = (e) => {
        ...
        //testing using ready-made playlist
        // console.log("test1")
    ...
    return (
      <div>
          <button type="button" className="submitbutton"> <a className="start" href="http://localhost:3001/login">Start Here</a> </button>
          <form onSubmit={handleSubmit}>
          <input type="submit" value="Data Data"/>
          </form>
          {/* {error} */}
