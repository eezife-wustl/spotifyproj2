...
function MusicStats({audiodata}) {
    ...
    function setMusicTaste(val) {
        ...
        if (val >= 40 && val < 60) {
            return "balanced between positive"
        }
        if (val >= 60 && val < 80) {
            return "positive"
        }
      ...
      return (<Container>
            <h1> The most negative music will produce a more blue-ish hue, while the most positive music will produce a more purple hue. Your music taste tends to be <b>{setMusicTaste(valence)}</b>.  </h1>
